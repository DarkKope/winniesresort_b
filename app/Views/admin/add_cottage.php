...
<div class="main-content">
    <h2><i class="fas fa-plus"></i> Add New Cottage</h2>
    
    <div class="card mt-3">
        <div class="card-body">
            <form action="/admin/save-cottage" method="post" enctype="multipart/form-data">
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <small class="text-muted">Enter an image URL (optional if uploading file)</small>
                    </div>
                </div>
                
                <div class="mt-3">
                    <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Save Cottage</button>
